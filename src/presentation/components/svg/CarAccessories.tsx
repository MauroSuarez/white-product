...
const CarAccesoriesIcon: React.FC<SVGAttributes<SVGSVGElement>> = (props) => {
  return (
    <svg
      fill="#000000"
      width={props.width}
    ...
    >
      ...
      <g id="SVGRepo_iconCarrier">
        <g>
          ...
          <rect
            height={2}
            transform="matrix(0.7071 -0.7071 0.7071 0.7071 -13.2548 32)"
            width={19.799}
            x={22.101}
            y={31}
          />
          <rect
            height={2}
            transform="matrix(0.7129 -0.7012 0.7012 0.7129 -16.0907 24.6937)"
            width={19.963}
            x={12.134}
            y={31}
          />
